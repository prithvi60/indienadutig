    ...
    >
      <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-2 font-carter">
        <a href="https://flowbite.com/" class="flex items-center">
          <img src="/musiclogo.png" class="h-10 mr-1" alt="Flowbite Logo" />
        ...
        >
          ...
          >
            ...
            >
              <a
                class="block py-2 pl-3 pr-4 text-white-200 bg-blue-700 rounded md:bg-transparent md:text-white-100 md:p-0 md:dark:text-blue-500"
                aria-current="page"
              >
                Home
              </a>
            ...
            >
              <a class="block py-2 pl-3 pr-4 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-white-100 md:p-0 md:dark:hover:text-blue-500 dark:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">
                Artists
              </a>
            </li>
            <li
